...
if __name__ == "__main__":
    ...
    t_brute = timeit.timeit(lambda: knapsack_brute_force(big_weights, big_values, big_capacity),
                             number=1)
    t_bottom_up = timeit.timeit(lambda: knapsack_bottom_up(big_weights, big_values, big_capacity),
                                 number=1)
